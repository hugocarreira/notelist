...
### October 16, 2019 
- [guide/style.md at master · uber-go/guide](https://github.com/uber-go/guide/blob/master/style.md?utm_campaign=A%20Semana%20Go&utm_medium=email&utm_source=Revue%20newsletter) 
### August 7, 2019 
...
- [lileio/lile: Easily generate gRPC services in Go ⚡️](https://github.com/lileio/lile) 
- [thedevsaddam/gojsonq: A simple Go package to Query over JSON/YAML/XML/CSV Data](https://github.com/thedevsaddam/gojsonq) 
- [adjust/redismq: a durable message queue system for go based on redis, see also https://github.com/adjust/rmq](https://github.com/adjust/redismq) 
### May 9, 2019 
...
- [Django-allauth tutorial - William S. Vincent](https://wsvincent.com/django-allauth-tutorial/) 
### December 4, 2018 
...
- [OptimalBits/redbird: A modern reverse proxy for node](https://github.com/OptimalBits/redbird) 
### November 5, 2018 
...
- [Blazing fast IPC with gRPC ( Part 2 ) – Shobhit Chittora – Medium](https://medium.com/@chittorashobhit/blazing-fast-ipc-with-grpc-part-2-227635faa361) 
### November 1, 2018 
...
- [Mohamed Labouardy - Software Engineer/DevOps Engineer, 3x AWS Certified Interested in Serverless, Containers, Go, Distributed Systems & NLP.](http://www.blog.labouardy.com/) 
### October 16, 2018 
...
- [Automatizando tarefas com Cake - Artigos sobre HTML, JavaScript, CSS e desenvolvimento web](https://tableless.com.br/automatizando-tarefas-de-build-nuget-cake-netcore/) 
...
### May 21, 2018 
- [JSON Web Token Authentication with Nodejs, Express, and Passport from @haidermalik504 on @eggheadio](https://egghead.io/lessons/express-json-web-token-authentication-with-nodejs-express-and-passport) 
